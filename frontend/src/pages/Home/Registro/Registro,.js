...
//       setFormData({
//         ...formData,
//         [id]: files ? files[0] : value, // Si es un input tipo file, guarda el archivo
//       });
//     };
...
//           formDataObject.append(key, dataToSend[key]);
//         });
  
//         await createUsuario(formDataObject); // Llamada a la API
//         alert("Usuario registrado exitosamente");
//       } catch (error) {
//         console.error("Error al registrar usuario:", error);
//         alert("Hubo un error al registrar el usuario");
